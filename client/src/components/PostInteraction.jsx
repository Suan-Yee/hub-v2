        ...
        <div className="mt-2 flex pt-2 gap-5">
            <div className='flex gap-4 justify-between items-center text-sm'>
                <div className="flex items-center gap-1 cursor-pointer">
                    <Heart className={`w-4 h-4 2xl:w-5 2xl:h-5 hover:text-red-500 ${react ? 'fill-red-500 text-red-500' : ''}`} onClick={() => setReact((prev) => !prev)}/>
                    <span>1.2k</span>
                </div>
                <div className="flex items-center gap-1 cursor-pointer ">
                    <MessageCircle className="w-4 h-4 2xl:w-5 2xl:h-5 hover:text-blue-500" onClick={handleCommentClick} />
                    <span>20</span>
                </div>
                <div className="flex items-center gap-1 cursor-pointer ">
            ...
            <div className="border-2 rounded-3xl w-full flex items-center px-3 py-1">
                ...
                <SmilePlus className="w-5 h-5 2xl:w-5 2xl:h-5 cursor-pointer hover:text-blue-500 ml-2 text-yellow-400" />
            </div>
    </div>
    );
}
